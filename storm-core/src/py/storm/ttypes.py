...
class SupervisorInfo:
  ...
  thrift_spec = (
    ...
    (4, TType.LIST, 'used_ports', (TType.I32,None), [
    ], ), # 4
    (5, TType.LIST, 'meta', (TType.I32,None), [
    ], ), # 5
  ...
  def __init__(self, time_secs=None, hostname=None, assignment_id=None, used_ports=thrift_spec[4][4], meta=thrift_spec[5][4], scheduler_meta=thrift_spec[6][4], uptime_secs=None,):
    self.time_secs = time_secs
    self.hostname = hostname
    self.assignment_id = assignment_id
    if used_ports is self.thrift_spec[4][4]:
      used_ports = [
    ]
    self.used_ports = used_ports
    if meta is self.thrift_spec[5][4]:
      meta = [
    ]
    self.meta = meta
    if scheduler_meta is self.thrift_spec[6][4]:
      scheduler_meta = {
    }
  ...
  def write(self, oprot):
    ...
    if self.used_ports is not None:
      ...
      oprot.writeListBegin(TType.I32, len(self.used_ports))
    ...
    if self.meta is not None:
      ...
      oprot.writeListBegin(TType.I32, len(self.meta))
  ...
  def validate(self):
    ...
    if self.assignment_id is None:
      raise TProtocol.TProtocolException(message='Required field assignment_id is unset!')
    if self.uptime_secs is None:
      raise TProtocol.TProtocolException(message='Required field uptime_secs is unset!')
    return
...
class Assignment:
  ...
  thrift_spec = (
    ...
    (3, TType.MAP, 'executor_node_port', (TType.LIST,(TType.I32,None),TType.LIST,(TType.STRING,None)), {
    }, ), # 3
    (4, TType.MAP, 'executor_start_time_secs', (TType.LIST,(TType.I32,None),TType.I32,None), {
    }, ), # 4
  )
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i328 in xrange(_size324):
            _key329 = iprot.readString().decode('utf-8')
            _val330 = iprot.readString().decode('utf-8')
            self.node_host[_key329] = _val330
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.MAP:
          ...
          for _i335 in xrange(_size331):
            ...
            for _i342 in xrange(_size338):
              ...
              _key336.append(_elem343)
            iprot.readListEnd()
            _val337 = []
            (_etype347, _size344) = iprot.readListBegin()
            for _i348 in xrange(_size344):
              _elem349 = iprot.readString().decode('utf-8')
              _val337.append(_elem349)
            iprot.readListEnd()
            self.executor_node_port[_key336] = _val337
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.MAP:
          ...
          for _i354 in xrange(_size350):
            ...
            for _i361 in xrange(_size357):
              ...
              _key355.append(_elem362)
            iprot.readListEnd()
            _val356 = iprot.readI32();
            self.executor_start_time_secs[_key355] = _val356
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.node_host is not None:
      ...
      for kiter363,viter364 in self.node_host.items():
        oprot.writeString(kiter363.encode('utf-8'))
        oprot.writeString(viter364.encode('utf-8'))
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.executor_node_port is not None:
      oprot.writeFieldBegin('executor_node_port', TType.MAP, 3)
      oprot.writeMapBegin(TType.LIST, TType.LIST, len(self.executor_node_port))
      for kiter365,viter366 in self.executor_node_port.items():
        oprot.writeListBegin(TType.I32, len(kiter365))
        for iter367 in kiter365:
          oprot.writeI32(iter367)
        oprot.writeListEnd()
        oprot.writeListBegin(TType.STRING, len(viter366))
        for iter368 in viter366:
          oprot.writeString(iter368.encode('utf-8'))
        oprot.writeListEnd()
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.executor_start_time_secs is not None:
      oprot.writeFieldBegin('executor_start_time_secs', TType.MAP, 4)
      oprot.writeMapBegin(TType.LIST, TType.I32, len(self.executor_start_time_secs))
      for kiter369,viter370 in self.executor_start_time_secs.items():
        oprot.writeListBegin(TType.I32, len(kiter369))
        for iter371 in kiter369:
          oprot.writeI32(iter371)
        oprot.writeListEnd()
        oprot.writeI32(viter370)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class StormBase:
  ...
  thrift_spec = (
    ...
    (3, TType.I64, 'num_workers', None, None, ), # 3
  ...
  def __init__(self, name=None, status=None, num_workers=None, component_executors=None, launch_time_secs=None, owner=None,):
    self.name = name
    self.status = status
    self.num_workers = num_workers
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.I64:
          self.num_workers = iprot.readI64();
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.MAP:
  ...
  def write(self, oprot):
    ...
    if self.status is not None:
      ...
      oprot.writeFieldEnd()
    if self.num_workers is not None:
      oprot.writeFieldBegin('num_workers', TType.I64, 3)
      oprot.writeI64(self.num_workers)
      oprot.writeFieldEnd()
